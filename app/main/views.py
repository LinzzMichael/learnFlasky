...
from ..models import Permission,Role,Post, Comment
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        current_user.abort_me = form.about_me.data
...
def edit_profile_admin(id):
    ...
    if form.validate_on_submit():
        ...
        user.location = form.loacation.data
    ...
    form.loacation.data = user.location
